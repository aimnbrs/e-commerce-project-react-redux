    ...
    <Fragment>
      ...
      <div className="mainAboutContainer">
        <div className="aboutContainer">
          <div className="informations" style={{paddingRight:"40px"}}>
            <h1>Our Story</h1>
            <p>
            ...
            <p>
              {" "}
              Ut fringilla turpis in vehicula vehicula. Pellentesque congue ac
              orci ut gravida. Aliquam erat volutpat. Donec iaculis lectus a
              arcu facilisis, eu sodales lectus sagittis. Etiam pellentesque,
              magna vel dictum rutrum, neque justo eleifend elit, vel tincidunt
              erat arcu ut sem. Sed rutrum, turpis ut commodo efficitur, quam
        ...
        <div className="aboutContainer">
          ...
          <div className="informations" style={{paddingLeft:"40px"}}>
            <h1>Our Mission</h1>
            <p>
